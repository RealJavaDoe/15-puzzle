...
| ![alt text](https://github.com/RealJavaDoe/15-puzzle/blob/master/images/buttons/color.png) | Switch between black and white and color pictures: 500 pictures each (black and white pictures are displayed by default) |
...
### About copyright
All pictures are from [blackwhite.pictures](https://blackwhite.pictures) - now closed -, [pexels.com](https://www.pexels.com/), [pixabay.com](https://pixabay.com) and [unsplash.com](https://unsplash.com/). Thanks! I only resized and cropped each picture - to get the correct size of 512 x 512 pixels - before uploading and sharing them.
